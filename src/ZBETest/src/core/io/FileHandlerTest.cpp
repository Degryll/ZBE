...
TEST(FileHandler, Exist) {
  EXPECT_TRUE(zbe::FileHandler::exist("src/ZBETest/src/core/io/FileHandlerTest.cpp")) << "This file exist.";
...
TEST(FileHandler, ExistDir) {
  ...
  EXPECT_FALSE(zbe::FileHandler::existDir("src/ZBETest/src/core/io/FileHandlerTest.cpp")) << "This file is not a dir.";
...
TEST(FileHandler, OpenClose) {
  ...
  // Open existent file
  zbe::FileHandler *f = new zbe::FileHandler("src/ZBETest/src/core/io/FileHandlerTest.cpp","r");
