...
TEST(TicketedForwardList, IterationTicketedElements) {
  ...
  std::shared_ptr<zbe::TicketedElement<int> > t2 = l.push_front(2);
  std::shared_ptr<zbe::TicketedElement<int> > t3 = l.push_front(3);
  l.push_front(5);
  std::shared_ptr<zbe::TicketedElement<int> > t7 = l.push_front(7);
  l.push_front(11);
  std::shared_ptr<zbe::TicketedElement<int> > t13 = l.push_front(13);
  l.push_front(17);
  l.push_front(19);
  l.push_front(23);
  std::shared_ptr<zbe::TicketedElement<int> > t29 = l.push_front(29);
