...
#ifndef ZOMBIENOID_EVENTS_HANDLERS_ACTUATORS_ITEMCATCHER
#define ZOMBIENOID_EVENTS_HANDLERS_ACTUATORS_ITEMCATCHER
...
#endif // ZOMBIENOID_EVENTS_HANDLERS_ACTUATORS_ITEMCATCHER
