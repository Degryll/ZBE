...
//      SysError::setError("Bad config for SDLWindowDmnFtry - mainloop."s + name);
//      return;
//    }
//    if(!valueHolderName.is_string()) {
//      SysError::setError("Bad config for SDLWindowDmnFtry - valueHolder."s + name);
//      return;
//    }
//    if(!outValue.is_number()) {
//      SysError::setError("Bad config for SDLWindowDmnFtry - outValue."s + name);
//      return;
//    }
