...
bool BaseCollisionSelector::visit(StaticSolidAABB2D& param1, ConstantMovingCircle& param2, int64_t& time, OldCollisionData* data) {
...
bool BaseCollisionSelector::visit(StaticLimiterAABB2D& param1, ConstantMovingCircle& param2, int64_t& time, OldCollisionData* data) {
...
bool BaseCollisionSelector::visit(ConstantMovingCircle& param1, StaticSolidAABB2D& param2, int64_t& time, OldCollisionData* data) {
...
bool BaseCollisionSelector::visit(ConstantMovingCircle& param1, StaticLimiterAABB2D& param2, int64_t& time, OldCollisionData* data) {
...
bool BaseCollisionSelector::visit(ConstantMovingCircle&, ConstantMovingCircle&, int64_t&, OldCollisionData*) {
