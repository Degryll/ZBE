...
namespace zbe {
  ...
  class ZBEAPI IntersectionCollisionSelector : public CollisionSelector {
       ...
       */
      bool visit(StaticSolidAABB2D& param1, StaticSolidAABB2D& param2, uint64_t& time, OldCollisionData* data);
       ...
       *  \param normal Where collisión normal will be stored if a collision is detected,
       */
      inline bool visit(StaticLimiterAABB2D&, StaticLimiterAABB2D&, uint64_t&, OldCollisionData*);
       ...
       *  \param normal Where collisión normal will be stored if a collision is detected,
       */
      inline bool visit(StaticSolidAABB2D&, StaticLimiterAABB2D&, uint64_t&, OldCollisionData*);
       ...
       *  \param normal Where collisión normal will be stored if a collision is detected,
       */
      inline bool visit(StaticLimiterAABB2D&, StaticSolidAABB2D&, uint64_t&, OldCollisionData*);
...
bool IntersectionCollisionSelector::visit(StaticSolidAABB2D& param1, StaticSolidAABB2D& param2, uint64_t& time, OldCollisionData* data) {
...
bool IntersectionCollisionSelector::visit(StaticLimiterAABB2D& param1, StaticLimiterAABB2D& param2, uint64_t& time, OldCollisionData* data) {
  time=0; data->getPoint() = Point2D{0,0}; data->getNormal() = Vector2D{0,0};
  return (intersectionAABBAABB<2>(param1.getAABB2D(),param2.getAABB2D()));
}

bool IntersectionCollisionSelector::visit(StaticSolidAABB2D& param1, StaticLimiterAABB2D& param2, uint64_t& time, OldCollisionData* data) {
  time=0; data->getPoint() = Point2D{0,0}; data->getNormal() = Vector2D{0,0};
  return (intersectionAABBAABB<2>(param1.getAABB2D(),param2.getAABB2D()));
}

bool IntersectionCollisionSelector::visit(StaticLimiterAABB2D& param1, StaticSolidAABB2D& param2, uint64_t& time, OldCollisionData* data) {
  time=0; data->getPoint() = Point2D{0,0}; data->getNormal() = Vector2D{0,0};
  return intersectionAABBAABB<2>(param1.getAABB2D(),param2.getAABB2D());
}

bool IntersectionCollisionSelector::visit(StaticSolidAABB2D& param1, ConstantMovingCircle& param2, uint64_t& time, OldCollisionData* data) {
  time=0; data->getPoint() = Point2D{0,0}; data->getNormal() = Vector2D{0,0};
  return(intersectionCircleAABB2D(param2.getCircle(), param1.getAABB2D()));
}

bool IntersectionCollisionSelector::visit(StaticLimiterAABB2D& param1, ConstantMovingCircle& param2, uint64_t& time, OldCollisionData* data) {
  time=0; data->getPoint() = Point2D{0,0}; data->getNormal() = Vector2D{0,0};
  return(intersectionCircleAABB2D(param2.getCircle(), param1.getAABB2D()));
}

bool IntersectionCollisionSelector::visit(ConstantMovingCircle& param1, StaticSolidAABB2D& param2, uint64_t& time, OldCollisionData* data) {
  time=0; data->getPoint() = Point2D{0,0}; data->getNormal() = Vector2D{0,0};
  return(intersectionCircleAABB2D(param1.getCircle(), param2.getAABB2D()));
}

bool IntersectionCollisionSelector::visit(ConstantMovingCircle& param1, StaticLimiterAABB2D& param2, uint64_t& time, OldCollisionData* data) {
  time=0; data->getPoint() = Point2D{0,0}; data->getNormal() = Vector2D{0,0};
  return(intersectionCircleAABB2D(param1.getCircle(), param2.getAABB2D()));
}

bool IntersectionCollisionSelector::visit(ConstantMovingCircle& param1, ConstantMovingCircle& param2, uint64_t& time, OldCollisionData* data) {
  time=0; data->getPoint() = Point2D{0,0}; data->getNormal() = Vector2D{0,0};
