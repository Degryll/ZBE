...
public:
  ...
  */
  static void load() {
    ...
    factories.insert("OrientationRelative2DVelSetterFtry", std::make_shared<zbe::GenericFtry<zbe::Behavior<double, double, zbe::Vector2D, zbe::Vector2D >, OrientationRelative2DVelSetter>>("Behavior", "OrientationRelative2DVelSetterFtry"));
