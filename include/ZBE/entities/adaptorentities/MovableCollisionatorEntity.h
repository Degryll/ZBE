...
class MovableCollisionatorEntityAdapted : public MovableCollisionatorEntity<R, s>, public CollisionatorEntity<R, s>,  {
  public:
    ...
    std::shared_ptr< MovableCollisionator<s> > getMovableCollisionator() {return (a->getMovableCollisionator(entity));}
  ...
  private:
    T* entity;
    MovableCollisionatorAdaptor<T, s> *a;
};
