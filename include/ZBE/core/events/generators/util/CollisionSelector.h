...
class ZBEAPI CollisionSelector {
  public:
     ...
     */
    bool select(std::shared_ptr<CollisionObject> param1, std::shared_ptr<CollisionObject> param2, int64_t& time, OldCollisionData *data);
     ...
     *  \return False.
     */
    virtual bool visit(StaticSolidAABB2D& param1, StaticSolidAABB2D& param2, int64_t& time, OldCollisionData *data) = 0;
     ...
     *  \return False.
     */
    virtual bool visit(StaticLimiterAABB2D& param1, StaticLimiterAABB2D& param2, int64_t& time, OldCollisionData *data) = 0;
     ...
     *  \return False.
     */
    virtual bool visit(StaticSolidAABB2D& param1, StaticLimiterAABB2D& param2, int64_t& time, OldCollisionData *data) = 0;
     ...
     *  \return False.
     */
    virtual bool visit(StaticLimiterAABB2D& param1, StaticSolidAABB2D& param2, int64_t& time, OldCollisionData *data) = 0;
     ...
     *  \return True if there is a collision in the timeslot set by time, false otherwise.
     */
    virtual bool visit(StaticSolidAABB2D& param1, ConstantMovingCircle& param2, int64_t& time, OldCollisionData *data) = 0;
     ...
     *  \return True if there is a collision in the timeslot set by time, false otherwise.
     */
    virtual bool visit(StaticLimiterAABB2D& param1, ConstantMovingCircle& param2, int64_t& time, OldCollisionData *data) = 0;
     ...
     *  \return True if there is a collision in the timeslot set by time, false otherwise.
     */
    virtual bool visit(ConstantMovingCircle& param1, StaticSolidAABB2D& param2, int64_t& time, OldCollisionData *data) = 0;
     ...
     *  \return True if there is a collision in the timeslot set by time, false otherwise.
     */
    virtual bool visit(ConstantMovingCircle& param1, StaticLimiterAABB2D& param2, int64_t& time, OldCollisionData *data) = 0;
     ...
     *  \return True if there is a collision in the timeslot set by time, false otherwise.
     */
    virtual bool visit(ConstantMovingCircle& param1, ConstantMovingCircle& param2, int64_t& time, OldCollisionData *data) = 0;
};
