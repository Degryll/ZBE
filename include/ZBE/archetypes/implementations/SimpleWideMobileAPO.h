...
class SimpleWideMobileAPO : public SimpleWideMobile<s>, public ActivePhysicalObject {
  public:
    ...
    SimpleWideMobileAPO(std::initializer_list<double> position, uint64_t width, uint64_t actuatorsList, uint64_t collisionablesList) : SimpleWideMobile<s>(position, width), ActivePhysicalObject(actuatorsList, collisionablesList) {}
    ...
    SimpleWideMobileAPO(std::initializer_list<double> position, std::initializer_list<double> velocity, uint64_t width, uint64_t actuatorsList, uint64_t collisionablesList) : SimpleWideMobile<s>(position, velocity, width), ActivePhysicalObject(actuatorsList, collisionablesList) {}
    SimpleWideMobileAPO(Point<s> position, std::initializer_list<double> velocity, uint64_t width, uint64_t actuatorsList, uint64_t collisionablesList) : SimpleWideMobile<s>(position, velocity, width), ActivePhysicalObject(actuatorsList, collisionablesList) {}
    ...
    SimpleWideMobileAPO(std::initializer_list<double> position, Vector<s> velocity, uint64_t width, uint64_t actuatorsList, uint64_t collisionablesList) : SimpleWideMobile<s>(position, velocity ,width), ActivePhysicalObject(actuatorsList, collisionablesList) {}
