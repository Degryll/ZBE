...
public:
  ...
  */
  static void load() {
    ...
    factories.insert("UniformLinearMotion2DOnPlane", std::make_shared<GenericFtry<Behavior<float, Vector2D, Vector2D, Vector3D, Vector3D, Vector3D, Vector3D, Vector3D >, UniformLinearMotion2DOnPlane>>("Behavior", "UniformLinearMotion2DOnPlane"));
