...
#ifndef ZBE_FACTORIES_IMPLEMENTATIONS_DAEMONS_BEHAVIORDMNFTRY_H_
#define ZBE_FACTORIES_IMPLEMENTATIONS_DAEMONS_BEHAVIORDMNFTRY_H_
...
#endif  // ZBE_FACTORIES_IMPLEMENTATIONS_DAEMONS_BEHAVIORDMNFTRY_H_
