...
#ifndef ZBE_FACTORIES_IMPLEMENTATIONS_MAINLOOPEXITFTRY_H_
#define ZBE_FACTORIES_IMPLEMENTATIONS_MAINLOOPEXITFTRY_H_
...
#endif  // ZBE_FACTORIES_IMPLEMENTATIONS_MAINLOOPEXITFTRY_H_
